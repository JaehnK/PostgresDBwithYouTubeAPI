...
class YouTubeVideoMetadata:
    ...
    def get_simplified_metadata(self, video_url_or_id):
        """
        간소화된 메타데이터 (핵심 정보만)
        ...
        Returns:
            dict: 핵심 메타데이터만 포함
        """
        full_metadata = self.get_video_metadata(video_url_or_id)
        
        return {
            'video_id': full_metadata['video_id'],
            'title': full_metadata['title'],
            'channel_title': full_metadata['channel_title'],
            'duration': full_metadata['duration_formatted'],
            'view_count': full_metadata['view_count'],
            'like_count': full_metadata['like_count'],
            'comment_count': full_metadata['comment_count'],
            'published_at': full_metadata['published_at'],
            'video_url': full_metadata['video_url'],
            'thumbnail': full_metadata['thumbnail_high'],
        }
